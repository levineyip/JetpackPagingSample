package com.an.paginglibrary.sample.adapter;
...
public class ArticleListAdapter extends PagedListAdapter<Article, RecyclerView.ViewHolder> {
    ...
    public class ArticleItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(Article article) {
            ...
            Picasso.get().load(article.getEnvelopePic()).resize(250, 200).into(binding.itemImage);
    ...
    public interface OnItemClickListener{
        void onItemClick(int position, Article item);
    }
